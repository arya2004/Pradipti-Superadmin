...
var getAllStudents = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, drizzle_1.db.select().from(schema_1.students).execute()];
...
var getStudentById = function (studentId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                student = (_a.sent())[0];
                return [2 /*return*/, student || null];
        }
    });
}); };
exports.getStudentById = getStudentById;
// ✅ Update Student
var updateStudent = function (studentId, updateData) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, drizzle_1.db
...
// ✅ Delete Student
var deleteStudent = function (studentId) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, drizzle_1.db
