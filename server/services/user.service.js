...
exports.deleteUser = exports.getUserBySessionToken = exports.updateUser = exports.getUserByName = exports.getUserById = exports.getAllUsers = exports.createUser = void 0;
...
var getAllUsers = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, drizzle_1.db.select().from(schema_1.users).execute()];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, drizzle_1.db
                    .select()
                    .from(schema_1.users)
                    .where((0, drizzle_orm_1.eq)(schema_1.users.name, username)) // Filter by name (username)
                    .execute()];
            case 1:
                user = (_a.sent())[0];
                return [2 /*return*/, user || null]; // Return user or null if not found
        }
    });
}); };
...
var getUserBySessionToken = function (sessiontoken) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, drizzle_1.db
                    .select()
                    .from(schema_1.users)
                    .where((0, drizzle_orm_1.eq)(schema_1.users.sessiontoken, sessiontoken)) // Filter by sessiontoken
                    .execute()];
            case 1:
                user = (_a.sent())[0];
                return [2 /*return*/, user || null]; // Return user or null if not found
