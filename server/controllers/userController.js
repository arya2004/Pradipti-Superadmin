...
exports.createNewUser = exports.getUsers = void 0;
...
var getUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, user_service_1.getAllUsers)()];
            case 1:
                users = _a.sent();
                res.json(users);
                return [2 /*return*/];
...
var createNewUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, salt, password_hash, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                password_hash = (0, encryption_1.authentication)(salt, password);
