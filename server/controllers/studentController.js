...
var createStudent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var studentData, newStudentId, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                studentData = req.body;
                return [4 /*yield*/, studentService.createStudent(studentData)];
            case 1:
                newStudentId = _a.sent();
...
var getStudentById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                console.error("Error fetching student:", error_3);
                res.status(500).json({ error: "Internal server error" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
...
var updateStudent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var studentId, updateData, affectedRows, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 2:
                error_4 = _a.sent();
                console.error("Error updating student:", error_4);
                res.status(500).json({ error: "Internal server error" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
...
var deleteStudent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var studentId, affectedRows, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                studentId = Number(req.params.id);
                return [4 /*yield*/, studentService.deleteStudent(studentId)];
            case 1:
                affectedRows = _a.sent();
                if (affectedRows > 0) {
            ...
            case 2:
                error_5 = _a.sent();
                console.error("Error deleting student:", error_5);
                res.status(500).json({ error: "Internal server error" });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
